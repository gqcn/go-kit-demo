...
const (
	User_Create_FullMethodName = "/api.User/Create"
	User_Search_FullMethodName = "/api.User/Search"
)
...
func (c *userClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
...
func (UnimplementedUserServer) Create(context.Context, *CreateRequest) (*EmptyResponse, error) {
